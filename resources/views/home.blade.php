...
<body>
    ...
    <form class="max-w-sm md:max-w-3xl py-8 mx-auto">
        ...
        <div class="grid gap-6 mb-4 md:grid-cols-2">
            ...
            <div>
                <label for="matric_no"
                    class="block mb-2 text-sm font-semibold text-gray-900">Matriculation
                    Number
                </label>
        ...
        <div class="mb-4">
            <label for="password"
                class="block mb-2 text-sm font-semibold text-gray-900">Password</label>
        ...
        <button type="submit" name="signup"
            class="text-white bg-secondary-500 hover:bg-secondary-800 focus:ring-4 focus:outline-none focus:ring-primary-100 font-medium rounded-lg text-sm w-full sm:w-auto px-8 py-3 text-center">Sign Up</button>
    </form>
</body>
