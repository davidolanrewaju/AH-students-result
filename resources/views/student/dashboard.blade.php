...
<body>
            ...
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        <div class="py-3 px-4">
                            <span
                                class="block text-sm font-semibold text-gray-900 dark:text-white">{{ $student->first_name }}
                                {{ $student->last_name }}</span>
                            <span
                                class="block text-sm text-gray-500 truncate dark:text-gray-400">{{ $student->email }}</span>
                        </div>
    ...
    <section class="main-container md:flex md:flex-row md:items-start">
        {{-- Mobile Sidenav --}}
        ...
        <div class="flex-1 body-container mx-10 md:ml-72">
            <div class="topnav">
                <h1 class="text-primary-600 font-extrabold text-4xl py-4">Welcome {{ $student->first_name }}!</h1>
            </div>

            <div class="grid grid-rows-3 lg:grid-cols-3 lg:grid-rows-1 gap-4 my-10">
                <a href="#"
            ...
            <div class="grid grid-rows-2 gap-16 mt-20 mb-32">
                ...
                <div class="flex flex-col items-start py-2 border border-primary-100 rounded-2xl">
                    <div class="w-full mb-8">
                        <h5 class="text-2xl font-bold text-primary-500 pb-1 px-6">Recent Activities</h5>
                        <hr class="bg-primary-100 h-px border-0">
                    </div>
                    <div class="m-auto py-8">
